	...
	: m_controllerProxy(controllerProxy), m_id(0)
{
	...
	m_expandButton->setToolTip(QStringLiteral("显示/隐藏该分类下的书签"));
...
{
	QtMessageBox msgBox;
	msgBox.setText(QStringLiteral("删除分类"));
	msgBox.setInformativeText(QStringLiteral("确认删除该分类及其包含的书签？"));
